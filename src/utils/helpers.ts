...
// Calculate Percent
// ----------------------------------
const calculatePercentage = (value: number, total: number): number => Math.round((value / total) * 100)
...
// ----------------------------------
const extract = (objs: Array<object>, key: string) => objs.map((obj) => obj[key])
...
// ----------------------------------
const isObjectEmpty = (obj: object): boolean => obj && Object.keys(obj).length === 0
