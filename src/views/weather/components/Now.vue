  ...
  <div class="column justify-center items-center text-center q-mb-lg q-mt-xl q-pt-xl">
    <div class="row">
      <div class="col-auto">
        ...
        <div class="text-subtitle1 text-weight-regular">{{ activeRegion }} kraj</div>
      </div>
    </div>
    ...
    <div class="row justify-center">
      ...
      <div class="row items-center q-mr-sm">
        <span class="text-subtitle1">
          <q-icon color="blue-7" name="speed" title="Air pressure" style="font-size: 1.5em"></q-icon>
...
.compass {
  ...
  .arrow {
    ...
    &:before {
      border-bottom: 5px solid var(--text-base);
