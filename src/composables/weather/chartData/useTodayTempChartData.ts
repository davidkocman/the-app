...
export default function useTempChartData() {
  ...
  /**
   * It loops through the todaySeries array and pushes the minimum temperature for each hour into a new
   * array
   * @returns An array of numbers
   */
  ...
  /**
   * It takes the todaySeries data and returns an array of the maximum temperatures for the next 6 hours
   * @returns An array of numbers
   */
